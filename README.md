...
I built this mainly for my own viral genomics work, where I needed to run lots of SimPlot analyses automatically instead of clicking through the Windows interface a hundred times.
...
- Count how many positions differ between the query and a reference sequence.
...
| `-f`, `--outformat`              | Plot format (`png`, `pdf`, `svg`, `jpg`).                                      |
